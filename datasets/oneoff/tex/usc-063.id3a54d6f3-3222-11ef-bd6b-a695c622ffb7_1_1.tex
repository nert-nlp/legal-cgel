...
% # sent_id = usc-063.id3a54d6f3-3222-11ef-bd6b-a695c622ffb7_1_1
% # text = Any liability of the United States resulting from a reconciliation shall be charged against the applicable appropriation available to the Department of Defense (at the time of the reconciliation) for obligation for communications support and related supplies and services.
% # sent = any liability of the United States resulting from a reconciliation shall be charged against the applicable appropriation available to the Department of Defense at the time of the reconciliation for obligation for communications support and related supplies and services
    ...
    [\Node{Head}{VP},edge={line width=1pt}
        ...
        [\Node{Comp}{Clause}
            [\Node{Head}{VP},edge={line width=1pt}
                ...
                [\Node{Comp}{Clause}
                    [\Node{Head}{VP},edge={line width=1pt}
                        [\Node{Head}{V},edge={line width=1pt}[charged]]
                        [\Node{Comp}{PP}
                                ...
                                [\Node{Head}{Nom},edge={line width=1pt}
                                    ...
                                    [\Node{Mod}{AdjP}
                                        [\Node{Head}{AdjP},edge={line width=1pt}
                                            ...
                                            [\Node{Supplement}{PP}
                                                [\Node{Head}{P},edge={line width=1pt}[at,label={left:\p{(}}]]
                                                [\Node{Obj}{NP}
                                                    [\Node{Det}{DP}
                                                        [\Node{Head}{D},edge={line width=1pt}[the]]]
                                                    [\Node{Head}{Nom},edge={line width=1pt}
                                                        ...
                                                        [\Node{Comp}{PP}
                                                            ...
                                                            [\Node{Obj}{NP}
                                                                [\Node{Det}{DP}
                                                                    [\Node{Head}{D},edge={line width=1pt}[the]]]
                                                                [\Node{Head}{Nom},edge={line width=1pt}
                                                                    [\Node{Head}{N},edge={line width=1pt}[reconciliation,label={right:\p{)}}]]]]]]]]]
                                        [\Node{Comp}{PP}
                                            [\Node{Head}{P},edge={line width=1pt}[for]]
                                            [\Node{Obj}{NP}
                                                [\Node{Head}{Nom},edge={line width=1pt}
                                                    [\Node{Head}{N},edge={line width=1pt}[obligation]]
                                                    [\Node{Mod}{PP}
                                                        [\Node{Head}{P},edge={line width=1pt}[for]]
                                                        [\Node{Obj}{Coordination}
                                                            [\Node{Coordinate}{NP}
                                                                [\Node{Head}{Nom},edge={line width=1pt}
                                                                    [\Node{Mod}{Nom}
                                                                        [\Node{Head}{N} \hlgreen{\Info},edge={line width=1pt}[communications]]]
                                                            ...
                                                            [\Node{Coordinate}{NP}
                                                                ...
                                                                [\Node{Head}{NP},edge={line width=1pt}
                                                                    [\Node{Head}{Nom},edge={line width=1pt}
                                                                        [\Node{Mod}{AdjP}
                                                                            [\Node{Head}{Adj},edge={line width=1pt}[related]]]
                                                                        [\Node{Head}{Coordination},edge={line width=1pt}
                                                                            [\Node{Coordinate}{Nom}
                                                                                [\Node{Head}{N},edge={line width=1pt}[supplies]]]
                                                                            [\Node{Coordinate}{Nom}
                                                                                [\Node{Marker}{Coordinator}[and]]
                                                                                [\Node{Head}{Nom},edge={line width=1pt}
                                                                                    [\Node{Head}{N},edge={line width=1pt}[services,label={right:\p{.}}]]]]]]]]]]]]]]]]]]]]]]]
\node at (current bounding box.south)[yshift=-1cm]{
(1) plural-only form https://simple.wiktionary.org/wiki/communications};
        \end{forest}
