...
% # sent_id = usc-030.id88a8757f-4e86-11ef-8795-d6c340cedfe7_2_0
% # text = There are authorized to be appropriated to carry out this section such sums as may be necessary for fiscal year 2009 and each of the five succeeding fiscal years.
% # sent = there are authorized to be appropriated to carry out this section such sums as may be necessary for fiscal year 2009 and each of the five succeeding fiscal years
    ...
    [\Node{Head}{VP},edge={line width=1pt}
        ...
        [\Node{DisplacedSubj}{NP}
            [\Node{Head}{Nom},edge={line width=1pt}
                [\Node{Head}{Nom},edge={line width=1pt}
                    [\Node{Mod}{AdvP}
                        [\Node{Head}{Adv},edge={line width=1pt}[such]]]
                    [\Node{Head}{N},edge={line width=1pt}[sums]]]
                                            ...
                                            [\Node{Obj}{Coordination}
                                                [\Node{Coordinate}{NP}
                                                    [\Node{Head}{Nom},edge={line width=1pt}
                                                        ...
                                                        [\Node{Head}{N} \hlgreen{\Info},edge={line width=1pt}[2009]]]]
                                                [\Node{Coordinate}{NP}
                                                    ...
                                                    [\Node{Head}{NP},edge={line width=1pt}
                                                        [\Node{Head}{Nom},edge={line width=1pt}, before drawing tree={x+=4em}
                                                            [\Node{Det-Head}{DP},no edge
                                                                [\Node{Head}{D},edge={line width=1pt}[each]]] { \draw[-] (!uu.south) -- (); \draw[-,line width=1pt] (!u.south) -- (); }
                                                            [\Node{Comp}{PP}
                                                                ...
                                                                [\Node{Obj}{NP}
                                                                    ...
                                                                    [\Node{Head}{Nom},edge={line width=1pt}
                                                                        [\Node{Mod}{DP}
                                                                            [\Node{Head}{D},edge={line width=1pt}[five]]]
                                                                        [\Node{Head}{Nom},edge={line width=1pt}
                                                                            [\Node{Mod}{AdjP}
...
(1) Does not pass diagnostic for appositive modification{,} CGEL p. 447. (Fiscal year 2009 =/ 2009).};
        \end{forest}
