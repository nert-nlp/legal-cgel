...
% # sent_id = usc-072.iddf009dbb-0944-11ef-bc85-893f21b52987_2_0
% # text = A loan for a project made under this subchapter shall have a term of not more than 30 years after the date of completion of the project.
% # sent = a loan for a project made under this subchapter shall have a term of not more than 30 years after the date of completion of the project
% # tree_by = nschneid (2025-02-23)
    ...
    [\Node{Subj}{NP}
        ...
        [\Node{Head}{Nom},edge={line width=1pt}
            [\Node{Head}{Nom},edge={line width=1pt}
                [\Node{Head}{N},edge={line width=1pt}[loan]]
                [\Node{Comp}{PP}
                                ...
                                [\Node{Head}{Nom},edge={line width=1pt}
                                    [\Node{Mod}{AdjP}
                                        [\Node{Head}{AdjP},edge={line width=1pt}
                                            ...
                                            [\Node{Head}{Adj},edge={line width=1pt}[more]]]
                                        [\Node{Comp}{PP}
                                            ...
                                            [\Node{Obj}{NP}
                                                [\Node{Head}{Nom},edge={line width=1pt}, before drawing tree={x+=1.5em}
                                                    [\Node{Det-Head}{DP},no edge
                                                        [\Node{Head}{D},edge={line width=1pt}[30]]] { \draw[-] (!uu.south) -- (); \draw[-,line width=1pt] (!u.south) -- (); }]]]]
                                    [\Node{Head}{Nom},edge={line width=1pt}
                                            ...
                                            [\Node{Obj}{NP}
                                                ...
                                                [\Node{Head}{Nom},edge={line width=1pt}
                                                    ...
                                                    [\Node{Comp}{PP}
                                                        ...
                                                        [\Node{Obj}{NP}
                                                            [\Node{Head}{Nom},edge={line width=1pt}
                                                                [\Node{Head}{N},edge={line width=1pt}[completion]]
                                                                [\Node{Comp}{PP}
                                                                    [\Node{Head}{P},edge={line width=1pt}[of]]
                                                                    [\Node{Obj}{NP}
                                                                        [\Node{Det}{DP}
