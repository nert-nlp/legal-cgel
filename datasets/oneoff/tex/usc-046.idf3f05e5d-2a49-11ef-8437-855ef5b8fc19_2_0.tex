...
% # sent_id = usc-046.idf3f05e5d-2a49-11ef-8437-855ef5b8fc19_2_0
% # text = The Secretary shall not use financial status or economic reality examination techniques to determine the existence of unreported income of any taxpayer unless the Secretary has a reasonable indication that there is a likelihood of such unreported income.
% # sent = the Secretary shall not use financial status or economic reality examination techniques to determine the existence of unreported income of any taxpayer unless the Secretary has a reasonable indication that there is a likelihood of such unreported income
                                ...
                                [\Node{Head}{Nom},edge={line width=1pt}
                                    [\Node{Mod}{Nom}
                                        [\Node{Mod}{Nom}
                                            ...
                                            [\Node{Head}{N},edge={line width=1pt}[reality]]]
                                        [\Node{Head}{N},edge={line width=1pt}[examination]]]
                            ...
                            [\Node{Head}{VP},edge={line width=1pt}
                                ...
                                [\Node{Obj}{NP}
                                    [\Node{Det}{DP}
                                        [\Node{Head}{D},edge={line width=1pt}[the]]]
                                    [\Node{Head}{Nom},edge={line width=1pt}
                                        [\Node{Head}{N},edge={line width=1pt}[existence]]
                                        [\Node{Comp}{PP}
                                            ...
                                            [\Node{Obj}{NP}
                                                [\Node{Head}{Nom},edge={line width=1pt}
                                                    [\Node{Head}{Nom},edge={line width=1pt}
                                                        [\Node{Mod}{AdjP}
                                                            [\Node{Head}{Adj},edge={line width=1pt}[unreported]]]
                                                        [\Node{Head}{N},edge={line width=1pt}[income]]]
                                                    [\Node{Mod}{PP}
                                                        [\Node{Head}{P},edge={line width=1pt}[of]]
                                                        [\Node{Obj}{NP}
                                                            [\Node{Det}{DP}
                ...
                [\Node{PredComp}{NP}
                    ...
                    [\Node{Head}{Nom},edge={line width=1pt}
                        [\Node{Head}{Nom},edge={line width=1pt}
                            ...
                            [\Node{Head}{N},edge={line width=1pt}[indication]]]
                        [\Node{Comp}{Clause}
                                ...
                                [\Node{Head}{VP},edge={line width=1pt}
                                    ...
                                    [\Node{DisplacedSubj}{NP}
                                        [\Node{Det}{DP}
                                            [\Node{Head}{D},edge={line width=1pt}[a]]]
                                        [\Node{Head}{Nom},edge={line width=1pt}
                                            [\Node{Head}{N},edge={line width=1pt}[likelihood]]
                                            [\Node{Comp}{PP}
                                                [\Node{Head}{P},edge={line width=1pt}[of]]
                                                [\Node{Obj}{NP}
                                                    [\Node{Det}{DP}
                                                    ...
                                                    [\Node{Head}{Nom},edge={line width=1pt}
                                                        [\Node{Mod}{AdjP}
                                                            [\Node{Head}{Adj},edge={line width=1pt}[unreported]]]
                                                        [\Node{Head}{N},edge={line width=1pt}[income,label={right:\p{.}}]]]]]]]]]]]]]]]]
        \end{forest}
