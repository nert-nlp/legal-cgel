...
% # sent = the Attorney General may not award a grant under this subchapter to a nonprofit organization that _. holds money in offshore accounts for the purpose of avoiding paying the tax described _. in section 511(a) of title 26
                                                                    ...
                                                                    [\Node{Head}{VP},edge={line width=1pt}
                                                                        ...
                                                                        [\Node{Obj}{NP}
                                                                            [\Node{Det}{DP}
                                                                                [\Node{Head}{D},edge={line width=1pt}[the]]]
                                                                            [\Node{Head}{Nom},edge={line width=1pt}
                                                                                [\Node{Head}{N\idx{y}},edge={line width=1pt}[tax]]
                                                                                [\Node{Mod}{Clause\textsubscript{rel}}
                                                                                    [\Node{Head}{VP},edge={line width=1pt}
                                                                                        [\Node{Head}{VP},edge={line width=1pt}
                                                                                            ...
                                                                                            [\Node{Obj}{NP}
                                                                                                [\Node{Head}{Nom},edge={line width=1pt}
                                                                                                    [\Node{Head}{N},edge={line width=1pt}
                                                                                                        [\Node{Flat}{N}[section]]
                                                                                                        [\Node{Flat}{N} \hlgreen{\Info}[511(a)]]]
                                                                                                    [\Node{Mod}{PP}
                                                                                                        [\Node{Head}{P},edge={line width=1pt}[of]]
                                                                                                        [\Node{Obj}{NP}
                                                                                                            [\Node{Head}{Nom},edge={line width=1pt}
                                                                                                                [\Node{Head}{N},edge={line width=1pt}
                                                                                                                    [\Node{Flat}{N}[title]]
                                                                                                                    [\Node{Flat}{N}[26,label={right:\p{.}}]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]
\node at (current bounding box.south)[yshift=-1cm]{
(1) Needs review. Attaching low for now by convention. Unclear where this PP belongs. Perhaps it should go higher with \textquotesingle{}award\textquotesingle{} or \textquotesingle{}may not\textquotesingle{}; (2) The compound constuction of this number may merit review of the CD tag};
        \end{forest}
