                                                                                    ...
                                                                                    [\Node{Head}{VP},edge={line width=1pt}
                                                                                        ...
                                                                                        [\Node{Mod}{PP}
                                                                                            ...
                                                                                            [\Node{Obj}{NP}
                                                                                                [\Node{Head}{Nom},edge={line width=1pt}
                                                                                                    [\Node{Head}{Nom},edge={line width=1pt}
                                                                                                        [\Node{Flat}{N} \hlgreen{\Info}[section]]
                                                                                                        [\Node{Flat}{N}[511(a,label={right:\p{)}}]]]
                                                                                                    [\Node{Mod}{PP}
                                                                                                        [\Node{Head}{P},edge={line width=1pt}[of]]
                                                                                                        [\Node{Obj}{NP}
                                                                                                            [\Node{Head}{Nom},edge={line width=1pt}
                                                                                                                [\Node{Head}{Nom},edge={line width=1pt}
                                                                                                                    [\Node{Flat}{N} \hlgreen{\Info}[title]]
                                                                                                                    [\Node{Flat}{N}[26,label={right:\p{.}}]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]
\node at (current bounding box.south)[yshift=-1cm]{
(1) Attaching low for now. Consitiuency seems wrong. Is this mod or comp? Should it attach low or be quaternary branching? Seems like it should go higher with \textquotesingle{}may not\textquotesingle{}?; (2) parent Nom should be N; (3) parent Nom should be N};
        \end{forest}
