...
% # text = So far as practicable, whenever units, organizations, or members of the National Guard are returned to their National Guard status under section 325(b) 1 of this title, arms and equipment that the Secretary concerned determines are sufficient to accomplish their peacetime mission shall be returned with them.
% # sent = so far as practicable whenever units organizations or members of the National Guard are returned to their National Guard status under section 325(b)1 of this title arms and equipment that the Secretary concerned determines -- are sufficient to accomplish their peacetime mission shall be returned with them
                        ...
                        [\Node{Mod}{PP}
                            ...
                            [\Node{Obj}{NP}
                                [\Node{Head}{Nom},edge={line width=1pt}
                                    ...
                                    [\Node{Head}{N},edge={line width=1pt}[325(b)1]]]
                                [\Node{Mod}{PP}
                                    [\Node{Head}{P},edge={line width=1pt}[of]]
                                    [\Node{Obj}{NP}
                                        [\Node{Det}{DP}
